...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/hbuQuZovtBBsMP54qBxh/sections/specification-block/content-block-1/card/icon
---
...
| Icon          | <p>Select icon from the list.<br>Note: Icon will display only the image field is empty.</p> |
...
| Padding       | Adjust the padding to control spacing. (Top, Bottom, Left, Right)                           |
